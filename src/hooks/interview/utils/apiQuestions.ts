...
export const generateQuestionsFromApi = async (
  ...
  try {
    console.log("Calling generate-interview-questions edge function with payload:", params);
    ...
    if (response?.questions && Array.isArray(response.questions)) {
      ...
      const formattedQuestions: InterviewQuestion[] = response.questions.map((q: any) => ({
