  ...
  return (
    <div className="grid gap-6">
      <div className="grid gap-4 md:grid-cols-3 mb-6">
        <div className="p-4 border-l-4 border-l-blue-500 bg-white rounded-lg shadow-sm">
          <div className="space-y-1">
            <p className="text-sm text-muted-foreground">Overall Average</p>
            <p className="text-2xl font-bold">{averageScore.toFixed(1)}%</p>
          </div>
        </div>
        <div className="p-4 border-l-4 border-l-green-500 bg-white rounded-lg shadow-sm">
          <div className="space-y-1">
            <p className="text-sm text-muted-foreground">Quizzes Completed</p>
            <p className="text-2xl font-bold">{totalQuizzes}</p>
          </div>
        </div>
        <div className="p-4 border-l-4 border-l-purple-500 bg-white rounded-lg shadow-sm">
          <div className="space-y-1">
      ...
      {chartData.length > 0 && (
        <div>
          ...
          <div className="h-[250px] rounded-lg p-4 bg-white">
